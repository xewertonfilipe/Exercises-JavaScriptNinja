...
carro.obterMarcaModelo = function() {
    return 'Esse carro é um ' + carro.obeterMarca() + ' ' + carro.obterModelo();
}
...
carro.obterMarcaModelo(); //Esse carro é um FordX
...
carro.removePessoas(-4); //"Já temos 1 pessoa no carro!"
