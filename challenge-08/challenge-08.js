...
console.log( multiplication( 2, 20 ) ); //"Resultado da operação: 2 * 20 = 40"
console.log( division( 40, 4 ) ); //"Resultado da operação: 40 / 4 = 10"
console.log( mod( 10 % 3 ) ); //"Resultado da operação: 10 % 3 = 1"
console.log( test( 7, 6 ) ); //"Operação inválida"