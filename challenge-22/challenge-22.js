  (function() {
    ...
    */
    ...
    console.log( getFullName.call( ewerton ) );
    console.log( getFullName.call( filipe ) );
    ...
    */
    ...
    console.log( sum( 1, 5, 6, 7, 10, 15 ) );
    console.log( sum( 100, 120, 300, 400 ) );
    console.log( sum( 0.5, 1, 5000 ) );
