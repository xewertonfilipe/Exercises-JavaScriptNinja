(function() {
    ...
    */
    ...
    var arr = [ function() {}, undefined, null, {}, 1, 2, 3, 4, 'Teste'];
    console.log( 'Array com o método toString', arr.toString()) ;
    ...
    */
    ...
    console.log( brasil.unshift( 'Amazonas', 'Roraima', 'Amapá' ) );
